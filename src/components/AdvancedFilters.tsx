...
export function AdvancedFilters({
    ...
    return (
        <div className="w-full relative z-30">
            ...
            {expanded && (
                // Fixed overlay escapes the parent overflow-hidden so filters are always scrollable
                <div
                    className="fixed inset-0 z-[200] flex items-start justify-center bg-background/60 backdrop-blur-sm"
                    onClick={(e) => { if (e.target === e.currentTarget) setExpanded(false) }}
                >
                    <div className="w-full max-w-4xl mx-4 mt-24 mb-8 max-h-[calc(100vh-8rem)] overflow-y-auto custom-scrollbar animate-slide-up">
                        <div className="p-8 sm:p-12 bg-card border border-border/80 rounded-[2rem] space-y-16 shadow-2xl text-left glow-primary">
